...
const contactOptions = [
  {
    title: "Anmol Anubhav",
    description:
      "We welcome students nationwide to come on over and see how we bake happiness into every delicious Anmol treat.",
    cta: "Book a Visit",
    icon: Factory,
  },
  {
    ...
    description:
      "Spice up your journey by joining our flavor-packed retail network and becoming part of the Anmol Family.",
    cta: "Apply Now",
    icon: Truck,
  },
  {
        ...
        <div className="grid gap-10 md:grid-cols-3">
          {contactOptions.map((option) => (
            ...
            >
              ...
              <button className="mt-6 inline-flex items-center justify-start text-sm font-semibold text-primary transition-colors duration-200 group-hover:text-primary/80 md:text-base">
                {option.cta}
